...
import { ArtistAlbumModel, ArtistModel, ArtistSongModel } from '#modules/artists/models/index.ts'
import { ArtistService } from '#modules/artists/services/index.ts'
import { z } from 'zod'
import type { Routes } from '#common/types/index.ts'
